...
#V = (k1*q1**2 + k2*q2**2)/2
V = (k1*q1**2 + k2*q2**2)/2 + g*(m1*((s1.T*ey)[0] + l1) + m2*((s2.T*ey)[0] + a1 + l2))
# <codecell>
m2*((s2.T*ey)[0] + a1 + l2)
# <codecell>
...
params_values = {m1:2550, m2:1700, I1:53.125 ,I2:17.354 ,a1:9 ,l1: 4.5 ,l2: 8, k1:0, k2:0, d1:100, d2:100, g:9.81 }
